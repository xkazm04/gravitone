...
/* The sweep-timing inverse is pure arithmetic rather than a component, so it
 * lives in ./pricingEasing — and still leaves through here, which is where
 * both directions have always imported it from. */
export { easedTimeFor } from "./pricingEasing";
