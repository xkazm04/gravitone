...
// The prototype-round harness (see .claude/skills/prototype): 2 directional
// variants behind a switcher, the chosen tab persisted per module so a reload
// mid-review keeps the reviewer where they were. Deleted after a module
...
export default function PrototypeTabs({
  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-2" role="tablist" aria-label="Prototype variants">
        {variants.map((v) => {
